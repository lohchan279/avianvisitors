(function () {
  ...
  var SKETCH_VERSION = 'r25'; // r12: 84 eastern NA birds (PR #23) refined + re-cut. r11: full library restyle: every species
  ...
  var IMG_VERSION = 'r25'; // r12: 84 eastern NA birds (PR #23) refined + re-cut. r11: full library restyle: every species re-rendered
  ...
  function renderAtlasCards(animate) {
    ...
    // #v2 is overflow-y:hidden until this flag says otherwise, so a
    // renderer that skips it leaves the atlas unscrollable. The stamp
    // path calls this; the card renderer predates the flag.
    queueAtlasOverflowState();
